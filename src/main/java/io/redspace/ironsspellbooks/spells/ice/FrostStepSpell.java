...
public class FrostStepSpell extends AbstractSpell {
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        shadow.setShatterDamage(getDamage(spellLevel/4, entity));
    ...
    private float getDistance(int spellLevel, LivingEntity sourceEntity) {
        return (float) (Utils.softCapFormula(getEntityPowerMultiplier(sourceEntity)) * getSpellPower(spellLevel/4, null)) * .65f;
    }
